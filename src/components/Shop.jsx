    ...
    return(
        ...
        <div className='p-6 min-h-screen bg-black'>
            <div className='flex justify-between mb-6'>
                ...
                <button className=' cursor-pointer px-7 py-1 text-white bg-[#2D2D2D]'>Search</button>
                </div>
            ...
            <div className='flex flex-wrap gap-3 text-xs md:text-sm text-white'>
                {
                    data.Featured.map((product)=>{
                        return(
                        <div key={product.id} className='p-4 w-[calc((50%_-_0.5rem))] md:w-[calc((33.33333%_-_0.5rem))] bg-[#2D2D2D]'>
